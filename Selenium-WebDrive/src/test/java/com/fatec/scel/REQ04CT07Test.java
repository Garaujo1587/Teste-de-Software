...
public class REQ04CT07Test {
  ...
  public void rEQ04CT07() {
    ...
    driver.findElement(By.id("cep")).sendKeys("036550001");
    driver.findElement(By.cssSelector(".btn:nth-child(1)")).click();
    assertThat(driver.findElement(By.cssSelector(".text-danger:nth-child(3)")).getText(), is("CEP deve ter 8 caracteres"));
  }
}
